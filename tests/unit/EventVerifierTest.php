 ...
 */
class EventVerifierTest extends \PHPUnit\Framework\TestCase
{
    ...
    {
        $this->expectException(\ComplyCube\Exception\VerificationException::class);
        $ev = new EventVerifier('a_webhook_signature');
    ...
    public function testValidSignatureEvent()
    {
        $resp = "{\"id\":\"value\"}";
        $ev = new EventVerifier('a_webhook_signature');
        $e = $ev->constructEvent($resp, 'bc00414fa4d54277a3ed01e5ee258d9800a918a7791c7cda16d38b82f38f2150');
